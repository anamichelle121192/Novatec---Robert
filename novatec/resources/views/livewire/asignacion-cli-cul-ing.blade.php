<div x-data="{ activo: '', mostrar: false }" x-init="$watch('mostrar', value => console.log('mostrar:', value))">
    ...
    <div class="container botones-principales-cliente" >
        <div class="row">
            <div class="col-4" style="display: flex; justify-content: center;">
                <img src="assets/img/crear-client.png" alt="Falta definirlo con marketing" width="70px" height="70px">
                <button @click="activo = 'btn-agroexportador'; mostrar = true" id="btn-agroexportador" name="btn-agroexportador" type="button" x-bind:class="activo === 'btn-agroexportador' ? 'btn btn-info' : 'btn btn-light'">AGRO EXPORTADOR</button>
            </div>
            <div class="col-4" style="display: flex; justify-content: center;">
                <img src="assets/img/crear-client.png" alt="Falta definirlo con marketing" width="70px" height="70px">
                <button @click="activo = 'btn-distribuidor'; mostrar = true" id="btn-distribuidor" name="btn-distribuidor" type="button" x-bind:class="activo === 'btn-distribuidor' ? 'btn btn-info' : 'btn btn-light'">DISTRIBUIDOR</button>
            </div>
            <div class="col-4" style="display: flex; justify-content: center;">
                <img src="assets/img/crear-client.png" alt="Falta definirlo con marketing" width="70px" height="70px">
                <button @click="activo = 'btn-productor'; mostrar = true" id="btn-productor" name="btn-productor" type="button" x-bind:class="activo === 'btn-productor' ? 'btn btn-info' : 'btn btn-light'">PRODUCTOR</button>
            </div>
        </div>
    </div>
    <div x-show="mostrar">
